...
asynchronously revokes sessions and deletes the provider identity, Pakperk
profile, library, authored comments, blocks, reports, and pending account-owned
operations. It retains only narrowly necessary anonymized security/moderation
records for 90 days. Recoverable backups expire within 35 days.
