...
- name: materialize-owner-only-secrets
  ...
  args:
    - |
      ...
      chown 0:0 /work
      chmod 0700 /work
      rm -f /work/LLM_API_KEY /work/COMMENT_MODERATION_TOKEN /work/API_ORIGIN_HASH_SECRET /work/API_CURSOR_ENCRYPTION_KEYS /work/ACCOUNT_IDENTITY_FINGERPRINT_KEYS /work/ACCOUNT_DELETION_LEDGER_SIGNING_KEYS /work/ACCOUNT_DELETION_PROVIDER_IDENTITY_KEYS
      ...
      install -m 0400 /source/API_CURSOR_ENCRYPTION_KEYS /work/API_CURSOR_ENCRYPTION_KEYS
      chown 10001:10001 /work/API_CURSOR_ENCRYPTION_KEYS
...
- name: secret-source
  secret:
    ...
    items:
      ...
      - { key: {{ .Values.secret.apiCursorEncryptionKeysKey }}, path: API_CURSOR_ENCRYPTION_KEYS }
      {{- if .Values.features.accounts }}
